...
Context propagation is how all AI SDK calls within one request are grouped under a single trace rather than appearing as separate unrelated traces. This section defines both available propagation patterns and when each applies. See User Journeys 2 and 7 for the corresponding end-to-end flows.
